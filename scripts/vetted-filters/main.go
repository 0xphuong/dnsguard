...
// index and transforms the filters from it to DNSGuard's format.
package main
...
// category returns the DNSGuard category for this filter.  If there is no
...
// aghFilters is the JSON structure for DNSGuard's list of vetted filtering
