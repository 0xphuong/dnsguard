...
mkdir -p "$dist_docker"
cp "${dist_dir}/DNSGuard_linux_386/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_386_"
cp "${dist_dir}/DNSGuard_linux_amd64/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_amd64_"
cp "${dist_dir}/DNSGuard_linux_arm64/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_arm64_"
cp "${dist_dir}/DNSGuard_linux_arm_6/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_arm_v6"
cp "${dist_dir}/DNSGuard_linux_arm_7/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_arm_v7"
cp "${dist_dir}/DNSGuard_linux_ppc64le/DNSGuard/DNSGuard" \
	"${dist_docker}/DNSGuard_linux_ppc64le_"
