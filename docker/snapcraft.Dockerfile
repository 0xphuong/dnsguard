...
ARG CACHE_BUSTER=0
ARG VERSION=""
COPY --from=builder /app/DNSGuard_amd64.snap /DNSGuard_amd64.snap
COPY --from=builder /app/DNSGuard_arm64.snap /DNSGuard_arm64.snap
COPY --from=builder /app/DNSGuard_armhf.snap /DNSGuard_armhf.snap
COPY --from=builder /app/DNSGuard_i386.snap /DNSGuard_i386.snap
...
ADD snap /app/snap
ADD scripts /app/scripts
ADD DNSGuard_amd64.snap /app/DNSGuard_amd64.snap
ADD DNSGuard_arm64.snap /app/DNSGuard_arm64.snap
ADD DNSGuard_armhf.snap /app/DNSGuard_armhf.snap
ADD DNSGuard_i386.snap /app/DNSGuard_i386.snap
WORKDIR /app
RUN \
