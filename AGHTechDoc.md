# DNSGuard Technical Document

The document describes technical details and internal algorithms of DNSGuard.
...
Deactivate DNSStubListener and update DNS server address.  Create a new file: `/etc/systemd/resolved.conf.d/dnsguard.conf` (create a `/etc/systemd/resolved.conf.d` directory if necessary):
...
Example of version.json data:
	...
	"announcement": "DNSGuard v0.95-hotfix is now available!",
	"announcement_url": "",
...
Response:
	...
	{
	"new_version": "v0.95",
	"announcement": "DNSGuard v0.95 is now available!",
