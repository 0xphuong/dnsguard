// Package configmgr defines the DNSGuard on-disk configuration entities and
...
import (
	...
	"github.com/0xphuong/dnsguard/internal/next/agh"
	"github.com/0xphuong/dnsguard/internal/next/dnssvc"
	"github.com/0xphuong/dnsguard/internal/next/websvc"
...
type Config struct {
	...
	// Start is the time of start of DNSGuard.
	Start time.Time
