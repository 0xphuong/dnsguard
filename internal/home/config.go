...
import (
	...
	"github.com/0xphuong/dnsguard/internal/filtering/rulelist"
	"github.com/0xphuong/dnsguard/internal/querylog"
	"github.com/0xphuong/dnsguard/internal/schedule"
...
type osConfig struct {
	// Group is the name of the group which DNSGuard must switch to on
	// startup.  Empty string means no switching.
	Group string `yaml:"group"`
	// User is the name of the user which DNSGuard must switch to on
	// startup.  Empty string means no switching.
