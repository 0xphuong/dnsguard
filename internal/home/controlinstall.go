...
type getAddrsResponse struct {
	...
	// Version is the version of DNSGuard.
	//
...
// be set.  canAutofix is true if the port can be unbound by DNSGuard
...
const (
	resolvedConfPath = "/etc/systemd/resolved.conf.d/dnsguard.conf"
