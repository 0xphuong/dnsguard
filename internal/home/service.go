...
import (
	...
	"github.com/0xphuong/dnsguard/internal/ossvc"
...
const (
	serviceName        = "DNSGuard"
	serviceDisplayName = "DNSGuard service"
	serviceDescription = "DNSGuard: Network-level blocker"
)
...
func handleServiceInstallCmd(
	...
	if detectFirstRun(ctx, l, workDir, confPath) {
		slogutil.PrintLines(ctx, l, slog.LevelInfo, "", "Almost ready!\n"+
			"DNSGuard is successfully installed and will automatically start on boot.\n"+
			"There are a few more things that must be configured before you can use it.\n"+
			"Click on the link below and follow the Installation Wizard steps to finish setup.\n"+
			"DNSGuard is now available at the following addresses:")
