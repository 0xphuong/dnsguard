// Package version contains DNSGuard version information.
package version
...
// Channel returns the current DNSGuard release channel.
func Channel() (v string) {
	return channel
}

// vFmtFull defines the format of full version output.
const vFmtFull = "DNSGuard, version %s"

// Full returns the full current version of DNSGuard.
func Full() (v string) {
	return fmt.Sprintf(vFmtFull, version)
}

// GOARM returns the GOARM value used to build the current DNSGuard release.
func GOARM() (v string) {
	return goarm
}

// GOMIPS returns the GOMIPS value used to build the current DNSGuard
// release.
func GOMIPS() (v string) {
	return gomips
}

// Version returns the DNSGuard build version.
