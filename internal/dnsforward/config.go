...
// Config represents the DNS filtering configuration of DNSGuard.  The zero
...
type Config struct {
	...
	// IpsetList is the ipset configuration that allows DNSGuard to add IP
...
type TLSConfig struct {
	...
	// HTTPSListenAddrs should be the addresses DNSGuard is listening on for
